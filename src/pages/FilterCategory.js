                        ...
                        <div className="mx-auto max-w-screen-xl px-8 pt-8 pb-8">
                            <div className="sm:flex sm:items-center sm:justify-between">
                                <div className="text-center sm:text-left">
                                    <h1 className="text-2xl font-bold text-gray-900 sm:text-3xl">{getCategoryNameById(category)}</h1>

                                    <p className="mt-1.5 text-sm text-gray-500">Belirli bir kategoriye sahip popüler hikayeler arasında kaybol</p>
                                </div>
                            </div>
                        </div>
                    </header>
