        ...
        <div key={comment.id} className='w-full h-auto bg-white rounded-lg'>
            <div className='w-full px-4 flex pt-4'>
                <div className='w-1/12 h-10 flex items-center justify-center'>
                    <a href={`http://localhost:3000/user/${comment.user.id}`}> <img src={`http://localhost:8080/uploads/${comment.user.id}.jpg`} alt="profile pht" className='w-8 h-8 rounded-full' /></a>
                </div>
                                        ...
                                        <div key={reply.id} className='w-full px-4 py-2 bg-gray-100 rounded-lg mb-2'>
                                            <div className='w-full flex items-center'>
                                                <div className='w-1/12 h-8 flex items-center justify-center'>
                                                    <img src={`http://localhost:8080/uploads/${reply.user.id}.jpg`} alt="profile pht" className='w-6 h-6 rounded-full' />
                                                </div>
